...
export const ui: Record<Lang, Ui> = {
  it: {
    ...
    quote: {
      ...
      consent: "Ho letto l'informativa e accetto che i miei dati siano usati solo per rispondere a questa richiesta.",
      ...
      intro: "Buongiorno, vorrei un preventivo per Dimora Pangea.",
    },
  ...
  en: {
    ...
    quote: {
      ...
      consent: "I have read the privacy policy and agree to my data being used only to reply to this request.",
      sendWhatsapp: "Send request via WhatsApp",
      sendEmail: "Send request by email",
      note: "The request is not binding.",
      subject: "Quote request",
      intro: "Hello, I would like a quote for Dimora Pangea.",
    },
  ...
  de: {
    ...
    quote: {
      ...
      consent: "Ich habe die Datenschutzerklärung gelesen und bin einverstanden, dass meine Daten nur zur Beantwortung dieser Anfrage verwendet werden.",
      ...
      intro: "Guten Tag, ich möchte ein Angebot für Dimora Pangea.",
    },
  ...
  fr: {
    ...
    quote: {
      ...
      consent: "J'ai lu la politique de confidentialité et j'accepte que mes données soient utilisées uniquement pour répondre à cette demande.",
      ...
      intro: "Bonjour, je souhaiterais un devis pour Dimora Pangea.",
    },
